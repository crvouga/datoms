...
export class HttpClientDatomDatabaseServerComponent {
  ...
  private async _handleGetLatestTransaction(
    ...
    return {
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- transaction.txId is guaranteed to exist for latest transaction
  ...
  private _createView(viewConfig: DatomDatabaseViewConfig) {
