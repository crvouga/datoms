...
describe.each(FIXTURES)('DatomDatabase (%s)', (_name, createFixture) => {
  ...
  describe('Database query (Datalog)', () => {
    ...
    test('should handle many-to-many relationships', async () => {
      ...
      await db.write([
        // Students
        {op: true, e: '100000', a: 'person/name', v: 'Alice'},
        {op: true, e: '100001', a: 'person/name', v: 'Bob'},
        // Courses
        {op: true, e: '200000', a: 'course/title', v: 'Math 101'},
        {op: true, e: '200001', a: 'course/title', v: 'CS 101'},
        // Enrollments (many-to-many)
        {op: true, e: '300000', a: 'enrollment/student', v: 100000},
        {op: true, e: '300000', a: 'enrollment/course', v: 200000},
        {op: true, e: '300001', a: 'enrollment/student', v: 100000},
        {op: true, e: '300001', a: 'enrollment/course', v: 200001},
        {op: true, e: '300002', a: 'enrollment/student', v: 100001},
        {op: true, e: '300002', a: 'enrollment/course', v: 200000},
      ]);
